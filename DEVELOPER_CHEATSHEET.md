# SkillRaceCreator Developer Cheat Sheet
...
```bash
cd HeRmEz/projects/osrs-plugins/SkillRaceCreator
```
...
```bash
cd ../../..
git add projects/osrs-plugins/SkillRaceCreator
git commit -m "chore: update SkillRaceCreator submodule"
git push origin main
```
